...
try {
    ...
    assert(e.message.includes('too small'), 'Should throw buffer too small error');
...
assert.strictEqual(frame.allocationSize(), expectedSize, 'allocationSize should return correct size');
