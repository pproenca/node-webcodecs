...
// Test 1: Explicit displayWidth/displayHeight
{
  ...
  assert.strictEqual(
    frame.codedHeight,
    1080,
    'codedHeight should be preserved',
  );
...
// Test 2: Default displayWidth/displayHeight (should match coded dimensions)
{
  ...
  assert.strictEqual(
    frame.displayWidth,
    640,
    'displayWidth should default to codedWidth',
  );
  assert.strictEqual(
    frame.displayHeight,
    480,
    'displayHeight should default to codedHeight',
  );
...
// Test 4: Clone preserves display dimensions
{
  ...
  assert.strictEqual(
    cloned.displayWidth,
    200,
    'cloned frame should preserve displayWidth',
  );
  assert.strictEqual(
    cloned.displayHeight,
    150,
    'cloned frame should preserve displayHeight',
  );
...
// Test 5: Very large display dimensions
{
  ...
  assert.strictEqual(
    frame.displayWidth,
    8192,
    'large displayWidth should work',
  );
  assert.strictEqual(
    frame.displayHeight,
    4320,
    'large displayHeight should work',
  );
