...
// Test 2: VideoFrame without duration (should be undefined)
{
  ...
  assert.strictEqual(
    frame.duration,
    undefined,
    'duration should be undefined when not provided',
  );
...
// Test 3: Clone preserves duration
{
  ...
  assert.strictEqual(
    cloned.duration,
    40000,
    'cloned frame should preserve duration',
  );
  assert.strictEqual(
    cloned.timestamp,
    3000,
    'cloned frame should preserve timestamp',
  );
...
// Test 5: Large duration value
{
  ...
  assert.strictEqual(
    frame.duration,
    largeDuration,
    'large duration should be preserved',
  );
