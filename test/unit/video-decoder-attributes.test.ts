...
// Tests for W3C WebCodecs spec section 4.3 - VideoDecoder Attributes
...
/**
 * Tests for VideoDecoder attributes per W3C WebCodecs spec section 4.3.
 * Verifies state, decodeQueueSize, and ondequeue behavior.
 */

describe('VideoDecoder Attributes: 4.3', () => {
  ...
  describe('state attribute (readonly)', () => {
    // Spec 4.3: state returns [[state]] internal slot value
  ...
  describe('decodeQueueSize attribute (readonly)', () => {
    // Spec 4.3: decodeQueueSize returns [[decodeQueueSize]] internal slot value
    ...
    it('should be readonly (no setter)', () => {
      ...
      // Spec 4.3: decodeQueueSize is readonly
      const descriptor = Object.getOwnPropertyDescriptor(
        Object.getPrototypeOf(decoder),
        'decodeQueueSize',
      );
  ...
  describe('ondequeue event handler', () => {
    // Spec 4.3: ondequeue is event handler IDL attribute for 'dequeue' event
