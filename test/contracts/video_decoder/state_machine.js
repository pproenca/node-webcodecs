...
// Helper to create a test chunk (minimal H.264 data)
function createTestChunk() {
    // Minimal encoded data buffer (not valid H.264, but sufficient for state testing)
...
// Test runner
async function run() {
    console.log('Contract: VideoDecoder State Machine\n');
