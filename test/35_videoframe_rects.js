...
// Test 2: visibleRect defaults to codedRect
{
    ...
    assert.strictEqual(visibleRect.width, 1920, 'visibleRect.width should be 1920');
    assert.strictEqual(visibleRect.height, 1080, 'visibleRect.height should be 1080');
    assert.strictEqual(visibleRect.right, 1920, 'visibleRect.right should be 1920');
    assert.strictEqual(visibleRect.bottom, 1080, 'visibleRect.bottom should be 1080');
