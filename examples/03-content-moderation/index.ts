...
import {VideoEncoder, VideoFilter, VideoFrame} from '@pproenca/node-webcodecs';
...
function mockDetectContent(frameIndex: number): Array<{
  x: number;
  y: number;
  width: number;
  height: number;
